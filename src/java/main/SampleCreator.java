...
public class SampleCreator
{
    public static void main(String[] args)
    {
        ...
        List<SimulationContext> states = collector.collectStates(numSamples, initialState, true);
        ...
        DataSet samples = NeuralUtils.getDataSet(states, numSamples, fCollector, judge, globalConfig.consoleOutput, globalConfig.logFile);
